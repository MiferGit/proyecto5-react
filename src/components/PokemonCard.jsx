      ...
      <div className={`poke__card type--${types[0]}`}>
        ...
        <div className="poke__card-body">
          ...
          <div className="poke__card-stats">
            <div className="poke__card-stats-items">
              <span>HP </span>
              <span className="poke-power">{pokemon?.stats[0]?.base_stat}</span>
            </div>
            <div className="poke__card-stats-items">
              <span>Ataque </span>
              <span className="poke-power">{pokemon?.stats[1]?.base_stat}</span>
            </div>
            <div className="poke__card-stats-items">
              <span>Defensa </span>
              <span className="poke-power">{pokemon?.stats[2]?.base_stat}</span>
            </div>
            <div className="poke__card-stats-items">
              <span>Velocidad </span>
              <span className="poke-power">{pokemon?.stats[5]?.base_stat}</span>
            </div>
          </div>
        </div>
      </div>
